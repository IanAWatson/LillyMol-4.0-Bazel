...
static double
novartis_polar_surface_area_nitrogen (Molecule & m,
                                     atom_number_t zatom,
                                     Atom & a,
                                     int is_aromatic)
{
...
static double
novartis_polar_surface_area_oxygen (Molecule & m,
                                   atom_number_t zatom,
                                   Atom & a,
                                   int is_aromatic)
{
...
static double
novartis_polar_surface_area_sulphur (Molecule & m,
                                    atom_number_t zatom,
                                    Atom & a,
                                    int is_aromatic)
{
...
//#define DEBUG_NOVARTIS_POLAR_SURFACE_AREA_SULPHUR
  ...
  cerr << "atom " << zatom << " sulphur " << ncon << " connections, " << aromatic_bonds << " aromatic, " << single_bonds << " single bonds, " << double_bonds << " double bonds " << triple_bonds << " triple bonds\n";
#endif
...
static double
novartis_polar_surface_area_phosphorus (Molecule & m,
                                       atom_number_t zatom,
                                       Atom & a,
                                       int is_aromatic)
{
                             ...
                             const int * is_aromatic)
{
  ...
  cerr << "novartis_polar_surface_area:processing " << m.smiles() << ' ' << m.name() << " with " << matoms << " atoms\n";
#endif

...
class Reaction_3D_Replace
{
  ...
  public:
    ...
    int construct_from_msi_attribute (const msi_attribute * att);
    int ConstructFromProto(const ReactionProto::ThreeDReplace& proto);
...
//  int _do_toggle_kekule_form (Molecule & m, const Substructure_Results & sresults);
  ...
  public:
    ...
    template <typename P>
    int ConstructFromProto(const P& proto);
...
// private functions
  ...
  public:
    ...
    int write_msi (std::ostream &, int &, int);
    int ConstructFromProto(const ReactionProto::ScaffoldReactionSite& proto);
};
...
//  private functions
  ...
  public:
    ...
    int ConstructFromProto(const ReactionProto::SidechainReactionSite& proto);
...
//                          Molecule_and_Embedding ** reagent) const;
  ...
  public:
    ...
    int ConstructFromProto(const ReactionProto::Reaction& proto);

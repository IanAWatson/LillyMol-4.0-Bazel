...
template int
skip_to_string<iwstring_data_source>(iwstring_data_source &, char const *, int);
template int
skip_to_string<String_Data_Source>(String_Data_Source &, char const *, int);
...
int
SplitOnPlusses(const const_IWSubstring & buffer, resizable_array_p<const_IWSubstring> & parts,
               const char split)
{

...
//  match one of the ring_sizes specified in _ring_sizes. Make that flexible
    ...
    resizable_array_p<RingSizeCount> _ring_size_count;
...
//  private functions
    ...
    int _ring_size_counts_matched(const resizable_array<int> & ring_sizes_encountered) const;
...
//  private functions
  ...
  public:
    ...
    int ReadProto(iwstring_data_source&);
